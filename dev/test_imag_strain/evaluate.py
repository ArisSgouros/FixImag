...
def Run(box, ri, rj, strain_tensor, steps, remap_box, remap_point, case_name):
   ...
   strain_rate  = strain_tensor / steps
   def_grad     = strain_tensor + np.identity(3)
   ...
   with open("table1.csv", "a") as fileobj:
      fileobj.write("%7.3f,%7.3f," % (strain_tensor[1][1], strain_tensor[0][1]))
